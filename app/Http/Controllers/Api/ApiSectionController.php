...
class ApiSectionController extends ApiBaseController
{
    ...
    public function index(): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendPaginate(new SectionCollection($data));
    ...
    public function all(): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendResource(SectionResource::collection($data));
    ...
    public function show(int $id): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendResource(new SectionResource($item));
    ...
    public function store()
    {
        try {
            ...
            $storeRequest = new SectionStoreRequest();
    ...
    public function update()
    {
        try {
            ...
            $updateRequest = new SectionUpdateRequest();
