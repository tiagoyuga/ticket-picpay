...
class ApiTicketStatusController extends ApiBaseController
{
    ...
    public function index(): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendPaginate(new TicketStatusCollection($data));
    ...
    public function all(): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendResource(TicketStatusResource::collection($data));
    ...
    public function show(int $id): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendResource(new TicketStatusResource($item));
    ...
    public function store()
    {
        try {
            ...
            if (!\Auth::user()->can('create', TicketStatus::class)) {

                return $this->sendUnauthorized();
            }

            $storeRequest = new TicketStatusStoreRequest();
    ...
    public function update()
    {
        try {
            ...
            if (!\Auth::user()->can('update', TicketStatus::class)) {

                return $this->sendUnauthorized();
            }

            $updateRequest = new TicketStatusUpdateRequest();
