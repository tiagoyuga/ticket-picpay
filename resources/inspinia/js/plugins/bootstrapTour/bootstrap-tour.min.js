 ...
 ********************************************************************
 ...
 Call Tour.start() to start/Summary the Tour from previous step
...
(function (window, factory) {
    ...
    Tour = (function () {
            ...
            this._options = $.extend(true,
                {
                    ...
                    onSummary: function (tour, duration) {},
                ...
                this._options.steps[i] =  $.extend(true,
                    {
                        ...
                        onSummary: this._options.onSummary,
        ...
        Tour.prototype.start = function ()
        {
            ...
            // from first step. This provides the "Summary tour" functionality.
...
//						));
        ...
        Tour.prototype.Summary = function () {
            var step;
            step = this.getStep(this._current);
            if (!(step && step.duration)) {
                return this;
            ...
            if ((step.onSummary != null) && this._duration !== step.duration) {
                return step.onSummary(this, this._duration);
            }
        };
        ...
        Tour.prototype._template = function (step, i) {
            ...
            $Summary = $navigation.find('[data-role="pause-Summary"]');
            if (this._isOrphan(step)) {
...
//		};
        ...
        Tour.prototype._initMouseNavigation = function () {
            var _this;
            _this = this;
            return $(document).off("click.tour-" + this._options.name, ".popover.tour-" + this._options.name + " *[data-role='prev']").off("click.tour-" + this._options.name, ".popover.tour-" + this._options.name + " *[data-role='next']").off("click.tour-" + this._options.name, ".popover.tour-" + this._options.name + " *[data-role='end']").off("click.tour-" + this._options.name, ".popover.tour-" + this._options.name + " *[data-role='pause-Summary']").on("click.tour-" + this._options.name, ".popover.tour-" + this._options.name + " *[data-role='next']", (function (_this) {
                return function (e) {
                    e.preventDefault();
                    return _this.next();
                };
            ...
            })(this)).on("click.tour-" + this._options.name, ".popover.tour-" + this._options.name + " *[data-role='pause-Summary']", function (e) {
                var $this;
                e.preventDefault();
                $this = $(this);
                $this.text(_this._paused ? $this.data('pause-text') : $this.data('Summary-text'));
                if (_this._paused) {
                    return _this.Summary();
                } else {
                    return _this.pause();
