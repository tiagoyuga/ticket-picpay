...
class ApiQuoteController extends ApiBaseController
{
    ...
    public function index(): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendPaginate(new QuoteCollection($data));
    ...
    public function all(): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendResource(QuoteResource::collection($data));
    ...
    public function show(int $id): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendResource(new QuoteResource($item));
    ...
    public function store()
    {
        try {
            ...
            $storeRequest = new QuoteStoreRequest();
    ...
    public function update()
    {
        try {
            ...
            if (!\Auth::user()->can('update', Quote::class)) {

                return $this->sendUnauthorized();
            }

            $updateRequest = new QuoteUpdateRequest();
