            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="m-b-lg">
                            <form method="get" id="frm_search" action="{{ route('ticket_comments.index') }}">
                                            ...
                                            <tr id="tr-{{ $item->id }}">
                                                ...
                                                <td style="text-align: center">
                                                    ...
                                                    <a class="btn btn-sm btn-default" title="Edit"
                                                       href="{{ route('ticket_comments.edit', [$item->id]) }}"><i
                                                            class="fa fa-pencil"></i>
                                                    </a>

                                                    <link-destroy-component
                                                        line-id="{{ 'tr-'.$item->id }}"
                                                        link="{{ route('ticket_comments.destroy', [$item->id]) }}">
                                                    </link-destroy-component>
...
a new one with other terms or <a class="alert-link" href="{{ route('ticket_comments.index') }}">
                                        clear your search.
                                    </a>
                                </div>
                            @endif
