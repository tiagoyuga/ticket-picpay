...
class ApiProjectController extends ApiBaseController
{
    ...
    public function index(): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendPaginate(new ProjectCollection($data));
    ...
    public function all(): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendResource(ProjectResource::collection($data));
    ...
    public function show(int $id): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendResource(new ProjectResource($item));
    ...
    public function update()
    {
        try {
            ...
            if (!\Auth::user()->can('update', Project::class)) {
