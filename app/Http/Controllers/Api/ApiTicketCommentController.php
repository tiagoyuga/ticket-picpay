...
use App\Http\Resources\TicketCommentCollection;
use App\Http\Resources\TicketCommentResource;
use App\Services\TicketCommentService;
use Illuminate\Http\JsonResponse;
use Validator;

class ApiTicketCommentController extends ApiBaseController
{
     ...
     *
     * @param TicketCommentService $service
     */
    ...
    public function index(): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendPaginate(new TicketCommentCollection($data));
    ...
    public function all(): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendResource(TicketCommentResource::collection($data));
    ...
    public function show(int $id): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendResource(new TicketCommentResource($item));
    ...
    public function store()
    {
        try {
            ...
            if (!\Auth::user()->can('create', TicketComment::class)) {

                return $this->sendUnauthorized();
            }

            $storeRequest = new TicketCommentStoreRequest();
    ...
    public function update()
    {
        try {
            ...
            if (!\Auth::user()->can('update', TicketComment::class)) {

                return $this->sendUnauthorized();
            }

            $updateRequest = new TicketCommentUpdateRequest();
